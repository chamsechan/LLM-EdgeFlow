...
#endif
#ifndef EDGEFLOW_NON_TENSOR_ONNX_FIXTURE
#define EDGEFLOW_NON_TENSOR_ONNX_FIXTURE "models/non_tensor_output_fixture.onnx"
#endif
...
TEST_F(OnnxAndEmbeddingModelTest, OnnxRuntimeFixturePassEvidence) {
  ...
  const auto vocab_path =
      GetFixturePath("LLM_EDGEFLOW_TEST_BGE_VOCAB", EDGEFLOW_VOCAB_FIXTURE);
