...
本文保留 RFC-0059 实施时的目标设计、步骤及末尾验收记录，已于 2026-09-16 完成。
其中的双宿主入口后来由 [RFC-0060](../rfcs/0060-cpp-operator-only.md) 取代；后续重构也调整了注册和部署配置。
以下接口与命令按原始基线阅读，当前接入方式以[业务接入指南](../dev_guide/business_onboarding.md)和代码为准。
