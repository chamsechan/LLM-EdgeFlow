...
| **RFC-0009** | 公司平台 C 结构体槽位绑定与输出内存池 | `Proposed` | `v3.0.0` | Layer 1 (Platform Operator) / Demo | [0009-company-string-and-slot-map-struct-binding.md](0009-company-string-and-slot-map-struct-binding.md) |
