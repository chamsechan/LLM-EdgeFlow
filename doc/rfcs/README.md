...
| **RFC-0009** | 统一 CompanyString 封装与槽位 Mapname 结构体映射契约 | `Completed` | `v2.2.0` | Layer 1 (C ABI & Platform Adapter) | [0009-company-string-and-slot-map-struct-binding.md](0009-company-string-and-slot-map-struct-binding.md) |
