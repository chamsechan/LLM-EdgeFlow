...
| **RFC-0006** | 图形化算法方案工作台与 Catalog/Validator 单一事实源 | `In Implementation` | `v2.5.0` | Layer 1 ~ Layer 4 / Tooling | [0006-visual-pipeline-studio.md](0006-visual-pipeline-studio.md) |
