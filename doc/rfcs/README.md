...
| **RFC-0070** | 新人入口与接入名称信息收敛 | `Completed` | 投产前 | 接入适配层 / Tooling / Docs | [0070-onboarding-entrypoints.md](0070-onboarding-entrypoints.md) |
| **RFC-0071** | 删除 Pipeline 配置的重复概念与隐式绑定 | `Completed` | 投产前 | 流程编排层、能力节点层 / Tooling / Config | [0071-pipeline-configuration-simplicity.md](0071-pipeline-configuration-simplicity.md) |
