...
| **RFC-0008** | 架构契约收敛与文档一致性修复 | `In Implementation` | `v2.1.0` | Layer 1 ~ Layer 4 / Tooling | [0008-architecture-contract-consolidation.md](0008-architecture-contract-consolidation.md) |
