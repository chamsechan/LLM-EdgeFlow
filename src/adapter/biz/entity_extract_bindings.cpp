...
IoBindingDefinition MakeEntityExtractCAbiBinding() {
  IoBindingDefinition def;
  def.binding_id = "entity_extract.cabi.v1";
  def.biz_name = "entity_extract_v1";
  def.transport = "cabi";
  def.input_converter_id = "text.plain.cabi.v1";
  def.output_converter_id = "document.structured.cabi.v1";
...
REGISTER_IO_BINDING(MakeEntityExtractCAbiBinding());
