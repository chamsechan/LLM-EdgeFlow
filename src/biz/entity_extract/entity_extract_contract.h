...
#include "biz/entity_extract/entity_extract_dto.h"
#include "core/blackboard_key.h"
#include "core/common_contracts.h"

namespace alg_framework {

inline constexpr char kEntityExtractBizName[] = "entity_extract_0.6b_v1";
inline constexpr char kEntityExtractLlamaCppBizName[] =
