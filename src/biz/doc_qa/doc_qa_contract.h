...
#include "biz/doc_qa/doc_qa_dto.h"
...
inline constexpr char kDocQaBizName[] = "smart_doc_qa_v1";
inline constexpr char kDocQaOnnxBizName[] = "smart_doc_qa_onnx_llamacpp_v1";
inline constexpr char kDocQaRerankBizName[] = "smart_doc_qa_rerank_llm_v1";
