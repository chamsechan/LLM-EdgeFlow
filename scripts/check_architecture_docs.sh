...
ACTIVE_DOCS="doc/architecture.md doc/developer_guide.md doc/README.md doc/architecture.puml doc/architecture_v2.puml doc/assets/architecture_class_diagram.svg doc/assets/architecture_flow.svg README.md CLAUDE.md AGENTS.md src include demo configs"
...
echo "[Check 2/6] Checking for deprecated registration macros..."
...
for concept in "SharedAlgorithmRuntime" "Pipeline" "AlgContext" "NodeBase" "FixedBatchExecutor"; do
  if ! grep -q "${concept}" doc/architecture.puml; then
